      ...
      <header className="sticky top-0 z-50 glass border-b border-white/5 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-6">
          <div
            ...
            onClick={onReset}
          >
            <div className="w-8 h-8 rounded-lg accent-gradient flex items-center justify-center font-bold italic text-white group-hover:scale-110 transition-transform">P</div>
            <span className="font-bold text-xl tracking-tight whitespace-nowrap">HR Pulse <span className="text-gray-500 text-sm font-normal">2026</span></span>
          </div>
        </div>
